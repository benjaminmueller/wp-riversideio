/**
 * Functionality specific to Riverside.io.
 *
...
( function( $ ) {
	 ...
	 * navbar height.
	 */
	var riversideioAdjustAnchor = function() {
		if ( window.location.hash )
			window.scrollBy( 0, -49 );
	};

	$( document ).on( 'ready',    riversideioAdjustAnchor );
	$( window ).on( 'hashchange', riversideioAdjustAnchor );
